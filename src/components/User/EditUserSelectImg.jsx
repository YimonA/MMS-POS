...
const EditUserSelectImg = () => {
  ...
  return (
    <div className="w-[700px] h-[420px] flex flex-col justify-center items-center gap-10 px-5 ">
      <div className="w-full h-[330px] flex flex-wrap gap-5 justify-center items-start overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-slate-800 
      ">
         {/* overflow-y-scroll */}
        {/* Upload img start */}
